 ...
 * СТАТУС: ГЕНЕРАТОР НА 100+ СЪБИТИЯ (БЕЗ ИЗПОЛЗВАНЕ НА ЗАБРАНЕНИ ТЕРМИНИ)
 */
...
window.eventTemplates = {
    positive: [
        ...
        { t: "Мъдростта на владетеля {hero}", desc: "Вашето решение по съдебен спор между два рода увеличи влиянието Ви.", effect: { power: 25, gold: 0 } },
